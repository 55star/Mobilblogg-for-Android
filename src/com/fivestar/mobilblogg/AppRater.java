...
public class AppRater {
	...
	public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
		...
		dialog.setTitle(mContext.getText(R.string.rate) + " " + APP_TITLE);
		...
		b1.setText(mContext.getText(R.string.rate) + " " + APP_TITLE);
		...
		b2.setText(mContext.getText(R.string.later));
		...
		b3.setText(mContext.getText(R.string.no));
